...
import type { TaskRow } from './TaskManagement';
import usePostTask from '@/hooks/TaskPage/Mutate/usePostTask';
import { toIsoString } from './utils/dateUtils';

export type ProjectMemberLite = { projectMemberId: number; memberName?: string };
...
const MobileAddTask = ({ projectId, members, onClose, onSuccess }: Props) => {
  ...
  const assigneeNameById = useMemo(
    () =>
      members.reduce<Record<number, string>>((acc, cur) => {
